...
let allHands = [
    `<img class="hands" src="https://github.com/mahimahamsa/rock-paper-scissors-boilerplate/blob/main/assets/paper-hand.png?raw=true" alt="">`,
    `<img class="hands" src="https://github.com/mahimahamsa/rock-paper-scissors-boilerplate/blob/main/assets/rock-hand.png?raw=true" alt="">`,
    `<img class="hands" src="https://github.com/mahimahamsa/rock-paper-scissors-boilerplate/blob/main/assets/scissors-hand.png?raw=true" alt="">`
]
